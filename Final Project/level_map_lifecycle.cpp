...
void Shutdown() {
    ...
    g_particleImage.Resize(0, 0);
    g_particleHasAlpha = false;
    g_playerHpIconImage.Resize(0, 0);
    g_playerHpIconHasAlpha = false;
    g_playerArmorIconImage.Resize(0, 0);
    g_playerArmorIconHasAlpha = false;
    g_playerEnergyIconImage.Resize(0, 0);
    g_playerEnergyIconHasAlpha = false;
    g_energyDropImage.Resize(0, 0);
    g_energyDropHasAlpha = false;
    g_recoverPotionDropImage.Resize(0, 0);
    g_recoverPotionDropHasAlpha = false;
    g_energyPotionDropImage.Resize(0, 0);
    g_energyPotionDropHasAlpha = false;
    g_lifePotionDropImage.Resize(0, 0);
    g_lifePotionDropHasAlpha = false;
